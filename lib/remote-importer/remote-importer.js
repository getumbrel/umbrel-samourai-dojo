...
let Sources = network.key === 'bitcoin' ? (await import('./sources-mainnet.js')).default : (await import('./sources-testnet.js')).default
    ...
    async xpubScan(xpub, c, d, u, G, type, txids) {
        ...
        try {
            ...
            try {
                ...
                returnValue.transactions = returnValue.transactions.concat(filteredTxs)
